...
console.log(chalk.magentaBright('.𖦹 ๋࣭╼╾═╾⋙⋆⌠🌗⌡⋆⋘╾═╾╼ ๋࣭ 𖦹.'))
console.log(chalk.whiteBright('            🌙 Bienvenido al núcleo de la Bot GARA 🌙'))
console.log(chalk.whiteBright('     Prepara tu sesión... GARA no puede esperar para servirte querido usuario ✨'))
console.log(chalk.magentaBright('.𖦹 ๋࣭╼╾═╾⋙⋆⌠🌗⌡⋆⋘╾═╾╼ ๋࣭ 𖦹.\n'))
